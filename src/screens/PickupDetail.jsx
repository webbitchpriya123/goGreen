...
export default function PickupDetail(props) {
    ...
    const [walkData, setWasteData] = useState('');
    const waste = [
        {
...
const styles = StyleSheet.create({
    ...
    otpView: { backgroundColor: '#67C306', width: '35%', marginVertical: 16, borderRadius: 10, alignSelf: 'center' },
    ...
    flex5: { flex: 0.5 },
    flex: { marginHorizontal: 15,marginTop:10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
    vendor: { color: '#8C8A9D', fontSize: 12, fontFamily: '400', lineHeight: 25 },
    viewContainer: { padding: 13, height: 130, borderColor: '#F4F4F4', marginHorizontal: 15, borderWidth: 0.1, elevation: 1, marginVertical: 10 },
